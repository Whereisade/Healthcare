...
export default function Twoheading() {
  return (
    <div className="flex flex-col gap-4 md:gap-14 w-1/2 text-[#13182F]">
      <div>
        <p className="text-[14px] md:text-[20px] text-[#3A7DFF] font-[family-name:var(--font-proxnovar)]">
          Why Choose Us
        </p>
        <h1 className="text-[20px] md:text-[36px] font-[700] font-[family-name:var(--font-domainer)]">
          All-inclusive Medical Care for Everyone
        </h1>

  ...
  return (
    <>
        ...
        <Container>
          <div className=" py-[16px] px-[8px] md:px-[16px]  md:pt-[0px] flex flex-col-reverse md:flex-row  gap-5 md:gap-15 ">
            <div className=" md:flex md:flex-col md:justify-center  md:pt-[120px] ">
              ...
              >
                Embrace a <span className="text-[#3D65FF]">healthier</span>  you, Discover the power of <span className="text-[#3D65FF]">personalized care</span>
              </h1>
              <p
              ...
              <Button text="Request A Call" tcolo="text-white" bcolo="bg-[#3A7DFF]" className="" />
            </div>

            <div className="md:h-[700px] md:w-[2000px]">
            <Image
      ...
      <section className=" bg-[#F1F6FB] w-full">
        <Container>
          <div className="flex flex-col  p-2 md:p-16">
